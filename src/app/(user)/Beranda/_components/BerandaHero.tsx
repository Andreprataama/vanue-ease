...
const BerandaHero = () => {
  return (
    <section className="relative w-full h-[50vh] md:h-[95vh] ">
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-between text-white p-5 md:p-10 lg:px-20 lg:py-16">
        <div className="mt-20 md:mt-50 max-w-4xl">
          <h1 className="text-2xl sm:text-5xl lg:text-5xl  leading-tight tracking-tighter">
            Masa Depan
        ...
        <div className="flex flex-col md:flex-row justify-between items-end md:items-end gap-6 pt-10">
          <p className="text-[10px] md:text-sm text-gray-300 max-w-lg leading-relaxed">
          ...
          <Link href="/Tempat" passHref>
            <Button className="border-2 w-[80 px] md:w-[150px] hover:bg-white hover:text-black hover:border-black">
              Explore
            </Button>
          </Link>
        </div>
